...
if not NavigationStitcherOperatorUnitElement then
	slot2 = MissionElement
	slot0 = class(slot1)
end

NavigationStitcherOperatorUnitElement = slot0
...
function NavigationStitcherOperatorUnitElement:init(unit)
	...
	NavigationStitcherOperatorUnitElement.super.init(slot3, self)
...
function NavigationStitcherOperatorUnitElement:draw_links_unselected(...)
	...
	NavigationStitcherOperatorUnitElement.super.draw_links_unselected(slot2, ...)
...
function NavigationStitcherOperatorUnitElement:draw_links_selected(...)
	...
	NavigationStitcherOperatorUnitElement.super.draw_links_selected(slot2, ...)
