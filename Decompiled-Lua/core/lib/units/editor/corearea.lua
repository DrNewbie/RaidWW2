...
CoreAreaHubElement = slot0
slot0 = AreaHubElement

if not slot0 then
	slot0 = class
	slot2 = CoreAreaHubElement
	slot0 = slot0(slot1)
end

AreaHubElement = slot0
slot0 = AreaHubElement

function slot1(self, ...)
	slot1 = CoreAreaHubElement
	slot1 = slot1.init
	slot3 = self
