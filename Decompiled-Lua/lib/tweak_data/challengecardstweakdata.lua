...
function ChallengeCardsTweakData:init(tweak_data)
	...
	slot5 = "ececec"
	self.rarity_definition.loot_rarity_common.color = Color("cc_back_halloween_hud")
	...
	slot5 = "71b35b"
	self.rarity_definition.loot_rarity_uncommon.color = Color("cc_back_halloween_hud")
	...
	slot5 = "718c9e"
	self.rarity_definition.loot_rarity_rare.color = Color("cc_back_halloween_hud")
...
function ChallengeCardsTweakData:get_all_cards_indexed()
	local result = {}
	local counter = 1
	slot5 = self.cards_index

	for _, card_key_name in pairs(slot4) do
...
function ChallengeCardsTweakData:get_cards_by_rarity(rarity)
	...
	for key, card in pairs(slot4) do
		if card.rarity == rarity then
			slot11 = key

			table.insert(slot9, cards)
		end
	end
