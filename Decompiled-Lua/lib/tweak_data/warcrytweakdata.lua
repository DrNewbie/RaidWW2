...
function WarcryTweakData:init(tweak_data)
	...
	self._init_data_sharpshooter(slot3)

	slot4 = self

	self._init_data_berserk(slot3)

	slot4 = self

	self._init_data_ghost(slot3)

	slot4 = self

	self._init_data_clustertruck(slot3)
...
function WarcryTweakData:_init_data_sharpshooter()
	...
	slot4 = "warcry_sharpshooter"
	self.sharpshooter.ids_effect_name = Idstring()
...
function WarcryTweakData:_init_data_berserk()
	...
	slot4 = "warcry_berserk"
	self.berserk.ids_effect_name = Idstring()
...
function WarcryTweakData:_init_data_ghost()
	...
	slot4 = "warcry_ghost"
	self.ghost.ids_effect_name = Idstring()
...
function WarcryTweakData:_init_data_clustertruck()
	...
	slot4 = "warcry_clustertruck"
	self.clustertruck.ids_effect_name = Idstring()
