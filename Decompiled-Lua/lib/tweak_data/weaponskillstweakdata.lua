...
function WeaponSkillsTweakData:init()
	...
	self._init_skills(slot2)

	slot3 = self

	self._init_m1911_skill_tree(slot2)

	slot3 = self

	self._init_c96_skill_tree(slot2)

	slot3 = self

	self._init_thompson_skill_tree(slot2)

	slot3 = self

	self._init_mp38_skill_tree(slot2)

	slot3 = self

	self._init_sterling_skill_tree(slot2)

	slot3 = self

	self._init_sten_skill_tree(slot2)

	slot3 = self

	self._init_m1903_skill_tree(slot2)

	slot3 = self

	self._init_mosin_skill_tree(slot2)

	slot3 = self

	self._init_garand_skill_tree(slot2)

	slot3 = self

	self._init_garand_golden_skill_tree(slot2)

	slot3 = self

	self._init_m1918_skill_tree(slot2)

	slot3 = self

	self._init_mg42_skill_tree(slot2)

	slot3 = self

	self._init_mp44_skill_tree(slot2)

	slot3 = self

	self._init_m1912_skill_tree(slot2)

	slot3 = self

	self._init_carbine_skill_tree(slot2)

	slot3 = self

	self._init_webley_skill_tree(slot2)

	slot3 = self

	self._init_geco_skill_tree(slot2)

	slot3 = self

	self._init_dp28_skill_tree(slot2)

	slot3 = self

	self._init_tt33_skill_tree(slot2)

	slot3 = self

	self._init_ithaca_skill_tree(slot2)

	slot3 = self

	self._init_kar_98k_skill_tree(slot2)

	slot3 = self

	self._init_bren_skill_tree(slot2)

	slot3 = self

	self._init_lee_enfield_skill_tree(slot2)

	slot3 = self

	self._init_browning_skill_tree(slot2)

	slot3 = self

	self._init_shotty_skill_tree(slot2)

	slot3 = self

	self._init_reedem_xp_values(slot2)
