...
function GuiTweakData:init()
	...
	self._setup_layers(slot2)

	slot3 = self

	self._setup_colors(slot2)

	slot3 = self

	self._setup_hud_colors(slot2)

	slot3 = self

	self._setup_fonts(slot2)

	slot3 = self

	self._setup_font_paths(slot2)

	slot3 = self

	self._setup_icons(slot2)

	slot3 = self

	self._setup_menu_elements_icons(slot2)

	slot3 = self

	self._setup_radial_icons(slot2)

	slot3 = self

	self._setup_hud_icons(slot2)

	slot3 = self

	self._setup_hud_waypoint_icons(slot2)

	slot3 = self

	self._setup_hud_reticles(slot2)

	slot3 = self

	self._setup_map_icons(slot2)

	slot3 = self

	self._setup_skill_icons(slot2)

	slot3 = self

	self._setup_skill_big_icons(slot2)

	slot3 = self

	self._setup_backgrounds(slot2)

	slot3 = self

	self._setup_images(slot2)

	slot3 = self

	self._setup_mission_photos(slot2)

	slot3 = self

	self._setup_optical_flares(slot2)

	slot3 = self

	self._setup_xp_icons(slot2)

	slot3 = self

	self._setup_paper_icons(slot2)

	slot3 = self

	self._setup_old_tweak_data(slot2)
...
function GuiTweakData:_setup_colors()
	self.colors = {}
	slot4 = "deaf3e"
	self.colors.raid_debug = Color(slot3)
	slot4 = "de4a3e"
	self.colors.raid_red = Color(slot3)
	slot4 = "c04236"
	self.colors.raid_dark_red = Color(slot3)
	slot4 = "b8392e"
	self.colors.raid_light_red = Color(slot3)
	slot4 = "d7d7d7"
	self.colors.raid_white = Color(slot3)
	slot4 = "d3d3d3"
	self.colors.raid_dirty_white = Color(slot3)
	slot4 = "9e9e9e"
	self.colors.raid_grey = Color(slot3)
	slot4 = "565656"
	self.colors.raid_dark_grey = Color(slot3)
	slot4 = "0f0f0f"
	self.colors.raid_black = Color(slot3)
	slot4 = "c78e38"
	self.colors.raid_gold = Color(slot3)
	slot4 = "d8b883"
	self.colors.raid_light_gold = Color(slot3)
	slot5 = 0.09803921568627451
	self.colors.raid_list_background = Color.white.with_alpha(slot3, Color.white)
	slot5 = 0.15
	self.colors.raid_select_card_background = Color.white.with_alpha(slot3, Color.white)
	slot5 = 0.1
	self.colors.raid_unlock_select_background = Color.white.with_alpha(slot3, Color.white)
	slot5 = 0.09803921568627451
	self.colors.raid_table_background = Color.white.with_alpha(slot3, Color.white)
	...
	slot4 = "797f88"
	self.colors.progress_bar_dot = Color(slot3)
	slot4 = "787878"
	self.colors.raid_grey_effects = Color(slot3)

	return 
end
function GuiTweakData:_setup_hud_colors()
	slot4 = "1f1f22"
	self.colors.ammo_background_outline = Color(slot3)
	slot4 = "222222"
	self.colors.ammo_text = Color(slot3)
	slot4 = "ECECEC"
	self.colors.warcry_inactive = Color(slot3)
	slot4 = "dd9a38"
	self.colors.warcry_active = Color(slot3)
	slot4 = "dd9a38"
	self.colors.xp_breakdown_active_column = Color(slot3)
	slot4 = "dd9a38"
	self.colors.interaction_bar = Color(slot3)
	slot4 = "9e9e9e"
	self.colors.teammate_interaction_bar = Color(slot3)
	slot4 = "64bc4c"
	self.colors.progress_green = Color(slot3)
	slot4 = "dd9a38"
	self.colors.progress_yellow = Color(slot3)
	slot4 = "dd5c23"
	self.colors.progress_orange = Color(slot3)
	slot4 = "b8392e"
	self.colors.progress_red = Color(slot3)
	slot4 = "222222"
	self.colors.toast_notification_border = Color(slot3)
	slot4 = "b8392e"
	self.colors.turret_overheat = Color(slot3)
	slot4 = "222222"
	self.colors.chat_border = Color(slot3)
	slot4 = "ECECEC"
	self.colors.light_grey = Color(slot3)
	...
	slot4 = "c68e38"
	self.colors.gold_orange = Color(slot3)
	slot4 = "d6c8b2"
	self.colors.intel_newspapers_text = Color(slot3)
...
function GuiTweakData:_setup_font_paths()
	...
	self._setup_din_compressed_font_paths(slot2)

	slot3 = self

	self._setup_din_compressed_outlined_fonts(slot2)

	slot3 = self

	self._setup_lato_outlined_fonts(slot2)

	slot3 = self

	self._setup_lato_font_paths(slot2)
...
function GuiTweakData:get_font_path(font, font_size)
	...
	slot9 = font
	slot11 = font_size
	slot6 = "[GuiTweakData:get_font_path] Falling back to the default for font " .. tostring(slot8) .. " with size " .. tostring(slot10)

	debug_pause(slot5, debug.traceback())
...
function GuiTweakData:_setup_old_tweak_data()
	...
	slot5 = min_amount_weapons / (self.WEAPON_ROWS_PER_PAGE * self.WEAPON_COLUMNS_PER_PAGE)
	self.MAX_WEAPON_PAGES = math.ceil(min_amount_masks / (self.MASK_ROWS_PER_PAGE * self.MASK_COLUMNS_PER_PAGE))
