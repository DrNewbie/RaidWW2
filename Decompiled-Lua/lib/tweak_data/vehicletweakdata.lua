...
function VehicleTweakData:init(tweak_data)
	...
	self._init_data_jeep_willy(slot3)

	slot4 = self

	self._init_data_kubelwagen(slot3)

	slot4 = self

	self._init_data_truck(slot3)

	slot4 = self

	self._init_data_foxhole(slot3)
...
function VehicleTweakData:_init_data_jeep_willy()
	...
	slot6 = 2.5
	self.jeep_willy.driver_camera_offset = Vector3(, 0, 0.2)
...
function VehicleTweakData:_init_data_truck()
	...
	self.truck.seats = {
		...
		passenger_front = {
			...
			allow_shooting = false,
			sound_environment_start = "enter_truck",
			shooting_pos = Vector3(slot5, 50, -20),
			camera_limits = {
				90,
				45
			}
		...
		passenger_back_right = {
			...
			next_seat = "passenger_back_left",
			driving = false,
			shooting_pos = Vector3(slot5, 50, 0)
		},
		passenger_back_left = {
			has_shooting_mode = true,
			name = "passenger_back_left",
	...
	slot6 = 20
	self.truck.driver_camera_offset = Vector3(, 0, 2)
...
function VehicleTweakData:_init_data_foxhole()
	...
	slot6 = 15.5
	self.foxhole.driver_camera_offset = Vector3(, 0, 0.2)
