...
function SubtitlesTweakData:init()
	...
	self._init_intro_video(slot2)

	slot3 = self

	self._init_mission_brief_b2(slot2)

	slot3 = self

	self._init_mission_brief_b4(slot2)

	slot3 = self

	self._init_mission_brief_a1(slot2)

	slot3 = self

	self._init_mission_brief_a2(slot2)

	slot3 = self

	self._init_mission_brief_a3(slot2)

	slot3 = self

	self._init_mission_brief_a4(slot2)

	slot3 = self

	self._init_mission_brief_a5(slot2)

	slot3 = self

	self._init_mission_brief_b1(slot2)

	slot3 = self

	self._init_mission_brief_b3(slot2)

	slot3 = self

	self._init_mission_brief_b5(slot2)

	slot3 = self

	self._init_debrief_success_1(slot2)

	slot3 = self

	self._init_debrief_success_2(slot2)

	slot3 = self

	self._init_debrief_success_3(slot2)

	slot3 = self

	self._init_debrief_success_4(slot2)

	slot3 = self

	self._init_debrief_success_5(slot2)

	slot3 = self

	self._init_debrief_success_6(slot2)

	slot3 = self

	self._init_debrief_success_7(slot2)

	slot3 = self

	self._init_debrief_success_8(slot2)

	slot3 = self

	self._init_debrief_success_9(slot2)

	slot3 = self

	self._init_debrief_success_10(slot2)

	slot3 = self

	self._init_debrief_success_11(slot2)

	slot3 = self

	self._init_debrief_success_12(slot2)

	slot3 = self

	self._init_debrief_success_13(slot2)

	slot3 = self

	self._init_debrief_success_14(slot2)

	slot3 = self

	self._init_debrief_failure_1(slot2)

	slot3 = self

	self._init_debrief_failure_2(slot2)

	slot3 = self

	self._init_debrief_failure_3(slot2)

	slot3 = self

	self._init_debrief_failure_4(slot2)

	slot3 = self

	self._init_debrief_failure_5(slot2)

	slot3 = self

	self._init_debrief_failure_6(slot2)

	slot3 = self

	self._init_debrief_failure_7(slot2)

	slot3 = self

	self._init_debrief_failure_8(slot2)

	slot3 = self

	self._init_debrief_failure_9(slot2)

	slot3 = self

	self._init_debrief_failure_10(slot2)

	slot3 = self

	self._init_debrief_failure_11(slot2)

	return 
end
function SubtitlesTweakData:get_subtitle(movie, time)
	slot6 = "/"
	local split_movie_path = string.split(slot4, movie)
	local movie_name = split_movie_path[#split_movie_path]
	local subtitle_data = self[movie_name]

	if not subtitle_data then
		slot11 = " not in SubtitlesTweakData"

		Application.error(slot7, Application, "[SubtitlesTweakData][get_subtitle] Movie ", movie)
	...
	for _, subtitle in ipairs(slot7) do
		if subtitle.time < time and time < subtitle.time + subtitle.length then
			slot14 = subtitle.id

			return managers.localization.text(slot12, managers.localization)
		end
	end
