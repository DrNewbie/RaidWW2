...
function DropLootTweakData:init(tweak_data)
	...
	self._init_pickups_properties(slot3)

	slot4 = self

	self._init_demo_tier(slot3)

	slot4 = self

	self._init_basic_crate_tier(slot3)

	slot4 = self

	self._init_default_tier(slot3)

	slot4 = self

	self._init_basic_shelf_tier(slot3)

	slot4 = self

	self._init_camp_shelf_tier(slot3)

	slot4 = self

	self._init_easy_enemy(slot3)

	slot4 = self

	self._init_normal_enemy(slot3)

	slot4 = self

	self._init_hard_enemy(slot3)

	slot4 = self

	self._init_special_enemy(slot3)

	slot4 = self

	self._init_crowbar_crate_tier(slot3)

	slot4 = self

	self._init_lockpick_crate_tier(slot3)

	slot4 = self

	self._init_crate_scrap_tier(slot3)

	slot4 = self

	self._init_elite_enemy(slot3)
