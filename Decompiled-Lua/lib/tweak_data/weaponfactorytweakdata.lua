...
function preload_all()
	slot2 = tweak_data.weapon.factory.parts

	for id, part in pairs(slot1) do
		if part.third_unit then
			local ids_unit_name = Idstring(slot6)
			slot12 = false

			managers.dyn_resource.load(part.third_unit, managers.dyn_resource, ids_unit, ids_unit_name, "packages/dyn_resources")
		else
			slot8 = "didn't have third"
...
function preload_all_units()
	slot2 = tweak_data.weapon.factory
	...
	for id, part in pairs(slot1) do
		if part.unit then
			...
			managers.dyn_resource.load(part.unit, managers.dyn_resource, ids_unit, ids_unit_name, "packages/dyn_resources")
		else
			slot8 = "didn't have unit"
...
function print_package_strings_part_unit()
	...
	for id, part in pairs(slot1) do
		if part.unit then
			slot9 = "w"
			local f = SystemFS.open(slot6, SystemFS, id .. ".package")
			slot9 = "<package>"
...
function print_package_strings()
	...
	for id, part in pairs(slot1) do
		if part.third_unit then
			slot7 = "<unit name=\"" .. part.third_unit .. "\"/>"
...
function print_parts_without_texture()
	slot3 = "print_parts_without_texture"
	...
	for id, part in pairs(slot1) do
		if part.pcs then
			...
			if bundle_folder then
				slot11 = bundle_folder
				guis_catalog = guis_catalog .. "dlcs/" .. tostring(slot10) .. "/"
			end

			guis_catalog = guis_catalog .. "textures/pd2/blackmarket/icons/mods/"
			slot12 = "texture"

			if not DB.has("textures/pd2/blackmarket/icons/mods/", DB, Idstring(guis_catalog .. id)) then
				slot9 = guis_catalog .. id
...
slot4 = "WIN32"
local is_win_32 = SystemInfo.platform("unit") == Idstring(SystemInfo)
...
function WeaponFactoryTweakData:init()
	...
	self._init_base_parts_for_cloning(slot2)

	slot3 = self

	self._init_silencers(slot2)

	slot3 = self

	self._init_nozzles(slot2)

	slot3 = self

	self._init_gadgets(slot2)

	slot3 = self

	self._init_vertical_grips(slot2)

	slot3 = self

	self._init_sights(slot2)

	slot3 = self

	self._init_m1911(slot2)

	slot3 = self

	self._init_webley(slot2)

	slot3 = self

	self._init_thompson(slot2)

	slot3 = self

	self._init_sten(slot2)

	slot3 = self

	self._init_garand(slot2)

	slot3 = self

	self._init_garand_golden(slot2)

	slot3 = self

	self._init_m1918(slot2)

	slot3 = self

	self._init_m1903(slot2)

	slot3 = self

	self._init_m1912(slot2)

	slot3 = self

	self._init_mp38(slot2)

	slot3 = self

	self._init_mp44(slot2)

	slot3 = self

	self._init_carbine(slot2)

	slot3 = self

	self._init_mg42(slot2)

	slot3 = self

	self._init_c96(slot2)

	slot3 = self

	self._init_mosin(slot2)

	slot3 = self

	self._init_sterling(slot2)

	slot3 = self

	self._init_geco(slot2)

	slot3 = self

	self._init_dp28(slot2)

	slot3 = self

	self._init_tt33(slot2)

	slot3 = self

	self._init_ithaca(slot2)

	slot3 = self

	self._init_kar_98k(slot2)

	slot3 = self

	self._init_bren(slot2)

	slot3 = self

	self._init_lee_enfield(slot2)

	slot3 = self

	self._init_browning(slot2)

	slot3 = self

	self._init_shotty(slot2)

	slot3 = self

	self.create_ammunition(slot2)

	slot3 = self

	self._init_content_unfinished(slot2)

	slot3 = self

	self._cleanup_unfinished_content(slot2)

	slot3 = self

	self._cleanup_unfinished_parts(slot2)
...
function WeaponFactoryTweakData:_init_thompson()
	...
	slot3 = self.wpn_fps_smg_thompson
	self.wpn_fps_smg_thompson_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_sten()
	...
	self.parts.wpn_fps_smg_sten_fg_wooden = {
		...
		stance_mod = {
			wpn_fps_smg_sten = {
				translation = Vector3(slot6, -0.1535, 10.5846)
			}
		}
	}
	...
	slot3 = self.wpn_fps_smg_sten
	self.wpn_fps_smg_sten_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_garand()
	...
	slot3 = self.wpn_fps_ass_garand
	self.wpn_fps_ass_garand_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_garand_golden()
	...
	slot3 = self.wpn_fps_ass_garand_golden
	self.wpn_fps_ass_garand_golden_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_m1918()
	...
	slot3 = self.wpn_fps_lmg_m1918
	self.wpn_fps_lmg_m1918_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_m1903()
	...
	self.parts.wpn_fps_snp_m1903_o_scope = {
		...
		stance_mod = {
			wpn_fps_snp_m1903 = {
				...
				translation = Vector3(slot6, 0.015, -30)
			}
		}
	}
	...
	slot3 = self.wpn_fps_snp_m1903
	self.wpn_fps_snp_m1903_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_kar_98k()
	...
	self.parts.wpn_fps_snp_kar_98k_o_scope = {
		...
		stance_mod = {
			wpn_fps_snp_kar_98k = {
				lens_distortion_power = 1.04,
				translation = Vector3(slot6, 0, -24)
			}
		}
	}
	...
	slot3 = self.wpn_fps_snp_kar_98k
	self.wpn_fps_snp_kar_98k_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_lee_enfield()
	...
	self.parts.wpn_fps_snp_lee_enfield_o_scope = {
		...
		stance_mod = {
			wpn_fps_snp_lee_enfield = {
				lens_distortion_power = 1.04,
				translation = Vector3(slot6, 0, -16)
			}
		}
	}
	...
	slot3 = self.wpn_fps_snp_lee_enfield
	self.wpn_fps_snp_lee_enfield_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_m1911()
	...
	slot3 = self.wpn_fps_pis_m1911
	self.wpn_fps_pis_m1911_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_geco()
	...
	slot3 = self.wpn_fps_sho_geco
	self.wpn_fps_sho_geco_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_dp28()
	...
	slot3 = self.wpn_fps_lmg_dp28
	self.wpn_fps_lmg_dp28_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_bren()
	...
	slot3 = self.wpn_fps_lmg_bren
	self.wpn_fps_lmg_bren_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_tt33()
	...
	slot3 = self.wpn_fps_pis_tt33
	self.wpn_fps_pis_tt33_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_m1912()
	...
	slot3 = self.wpn_fps_sho_m1912
	self.wpn_fps_sho_m1912_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_ithaca()
	...
	slot3 = self.wpn_fps_sho_ithaca
	self.wpn_fps_sho_ithaca_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_browning()
	...
	slot3 = self.wpn_fps_sho_browning
	self.wpn_fps_sho_browning_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_mp38()
	...
	slot3 = self.wpn_fps_smg_mp38
	self.wpn_fps_smg_mp38_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_mp44()
	...
	self.parts.wpn_fps_ass_mp44_o_scope = {
		...
		stance_mod = {
			wpn_fps_ass_mp44 = {
				...
				translation = Vector3(slot6, 0, -15)
			}
		}
	}
	...
	slot3 = self.wpn_fps_ass_mp44
	self.wpn_fps_ass_mp44_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_carbine()
	...
	slot3 = self.wpn_fps_ass_carbine
	self.wpn_fps_ass_carbine_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_mg42()
	...
	slot3 = self.wpn_fps_lmg_mg42
	self.wpn_fps_lmg_mg42_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_c96()
	...
	slot3 = self.wpn_fps_pis_c96
	self.wpn_fps_pis_c96_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_webley()
	...
	slot3 = self.wpn_fps_pis_webley
	self.wpn_fps_pis_webley_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_mosin()
	...
	self.parts.wpn_fps_snp_mosin_o_scope = {
		...
		stance_mod = {
			wpn_fps_snp_mosin = {
				lens_distortion_power = 1.04,
				translation = Vector3(slot6, 0, -21)
			}
		}
	}
	...
	slot3 = self.wpn_fps_snp_mosin
	self.wpn_fps_snp_mosin_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_sterling()
	...
	slot3 = self.wpn_fps_smg_sterling
	self.wpn_fps_smg_sterling_npc = deep_clone()
...
function WeaponFactoryTweakData:_init_shotty()
	...
	slot3 = self.wpn_fps_pis_shotty
	self.wpn_fps_pis_shotty_npc = deep_clone()
